...
- Reviewing the pre-recorded videos and completing the exercises
- Pre-recordings released 1 week before live teaching
- Live teaching (zoom) / demonstrating
    + Recorded and available afterwards
- Exercises in breakout groups
- Use google classroom to ask questions where possible
...
## Discussion topics for live session
...
- R can be used for various data cleaning tasks
- An alternative is the OpenRefine tool
  + uses an Excel-like interface
  + all operations are recorded and reversible
  
## Tasks before live teaching

- Go through OpenRefine Exercise
- Install R and RStudio, and required packages
